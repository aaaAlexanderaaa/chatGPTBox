...
export const NUMERIC_FIELDS = /** @type {NumericFieldSpec[]} */ ([
  ...
  { key: 'agentPreloadContextTokenCap', kind: 'int', min: 1000, max: 256000 },
  { key: 'agentContextTokenCap', kind: 'int', min: 1000, max: 256000 },
  { key: 'agentMaxSteps', kind: 'int', min: 1, max: 32 },
  { key: 'agentNoProgressLimit', kind: 'int', min: 1, max: 10 },
  { key: 'agentToolEventLimit', kind: 'int', min: 10, max: 300 },
